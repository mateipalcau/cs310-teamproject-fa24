...
@Test
    public void testFindPunchList4() throws SQLException {
        ...
        LocalDate ts = LocalDate.of(2018, Month.SEPTEMBER, 11);

        Badge b = badgeDAO.find("C8E646D8");
        ...
        /* Add Punches */
        p2.add(punchDAO.find(4064));
        p2.add(punchDAO.find(4116));
        p2.add(punchDAO.find(4121));
        p2.add(punchDAO.find(4252));
    ...
    public void testFindPunchList5() throws SQLException {
        ...
        Badge b = badgeDAO.find("99F0C0FA");
        ...
        /* Add Punches */
        p2.add(punchDAO.find(158));
        p2.add(punchDAO.find(243));
